...
/*************** Loggers *******************/
    static std::ofstream output_data_file("test/data/sender/sender_test_output.txt");
...
/************************/
    ...
    cadmium::dynamic::modeling::EOCs eocs_TOP = {
		...
		cadmium::dynamic::translate::make_EOC<Sender_defs::dataOut,output_data>("sender1")
    };
